...
import com.lanchat.adapter.UserExpandableListAdapter;
import com.lanchat.data.ChatMessage;
import com.lanchat.data.User;
...
public class InitActivity extends BasicActivity implements OnClickListener {
public static String hostIp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start);//绑定整个界面
...
//		}
		...
		String countStr = "当前有" + currentUsers.size() +"个用户在线";
