...
import com.lanchat.network.NetTcpFileReceiveThread;
import com.lanchat.network.NetThreadHelper;
...
public abstract class BasicActivity extends Activity {
	...
	protected static LinkedList<BasicActivity> queue = new LinkedList<BasicActivity>();
	...
	public static BasicActivity getActivity(int index) {
		...
		public void handleMessage(Message msg) {
			...
			case UsedConst.FILERECEIVEINFO: { // 更新接收文件进度条
				...
				queue.getLast().mNotification.contentView.setTextViewText(
						R.id.fileRec_info, "文件" + (sendedPer[0] + 1) + "接收中:"
								+ sendedPer[1] + "%");
			...
			case UsedConst.FILERECEIVESUCCESS: { // 文件接收成功
				...
				queue.getLast().mNotification.contentView.setTextViewText(
						R.id.fileRec_info, "第" + successNum[0] + "个文件接收成功");
